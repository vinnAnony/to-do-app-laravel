  ...
  methods: {
              ...
              case 0:
                Vue.swal({
                  ...
                  if (result.isConfirmed) {
                    axios__WEBPACK_IMPORTED_MODULE_1___default()["delete"]("http://to-do.appp/posts/" + id).then(function (response) {
    ...
    addPost: function addPost() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("http://to-do.appp/posts/", this.postData).then(function (response) {
        if (response.status === 200) {
          _this3.posts.unshift(_this3.postData);
    ...
    editPost: function editPost() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().put("http://to-do.appp/post-update/" + this.postData.id, this.postData).then(function (response) {
        if (response.status === 200) {
          _this4.posts = _this4.posts.map(function (pst) {
            if (pst.id == _this4.postData.id) {
              return _this4.postData;
            }
    ...
    toggleEdit: function toggleEdit(post) {
      this.editMode = true;
      this.postData = _objectSpread({}, post);
    },
...
var render = function () {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "w-full max-w-xl mx-auto bg-white px-5 py-7 mt-10" },
      [
        _c(
          "form",
          {
                  ...
                  _vm._l(_vm.posts, function (post, index) {
                    return _c("tr", { key: index }, [
                      ...
                      _c("td", { staticClass: "p-2 whitespace-nowrap" }, [
                        _c(
                          "div",
                          { staticClass: "font-medium text-green-500" },
